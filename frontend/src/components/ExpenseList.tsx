    ...
    return (
        <div className="flex items-center justify-between bg-white p-3 rounded-md shadow-sm mb-2">
            <div className="flex items-center space-x-4">
                ...
                <div>
                    <p className="font-semibold">{expense.description || expense.categorie.nom}</p>
                    <p className="text-sm text-gray-500">{format(new Date(expense.date), 'd MMMM yyyy', { locale: fr })}</p>
                </div>
            </div>
